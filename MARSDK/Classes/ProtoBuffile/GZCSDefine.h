...
// 字符串是否为空
#define kMARSUniqueIDString         @"com.guazi.im.uniqueID"
#define kMARSUnifiedAccessGroupkey  @"QNBW2BT8S6.com.guazi.imUniqueId"
...
#define MARS_WS(weakSelf)                __weak __typeof(self) weakSelf = self
...
#define IOSVER              [MARSUtil currentSystemVersion]


// 字符串是否为空
#define IsStrEmpty(_ref)    (((_ref) == nil) || ([(_ref) isEqual:[NSNull null]]) ||([(_ref)isEqualToString:@""]))

#define kMARSBundleVersion          [NSBundle mainBundle].infoDictionary[@"CFBundleVersion"]
...
#define MARS_RGBACOLOR(r,g,b,a)             [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:(a)]
#define MARS_RGBCOLOR(r,g,b)                MARS_RGBACOLOR(r,g,b,1.0f)

#define COLOR_CHAT_BAR                 MARS_RGBCOLOR( 245, 245, 247)

#define HEIGHT_LINE_1DP                 1

#define SEVEN_DAYS_SECONDS             7*24*60*60
#define SEVEN_DAYS_MILLISECONDS        7*24*60*60*1000
#define COLOR_NAV_BAR_BG                MARS_RGBCOLOR(0xfe,0xfe,0xff)   //默认导航bar颜色
#define COLOR_NAV_BAR_TINT              MARS_RGBCOLOR(30,37,41)   //默认导航bar tint颜色
#define COLOR_BACKGROUND                MARS_RGBCOLOR(0xf5,0xf7,0xfa)   //默认背景颜色

#define COLOR_MAIN              MARS_RGBCOLOR(0x1f,0xcd,0xbb)   // default
#define COLOR_MAIN_HL           MARS_RGBCOLOR(0x28,0xbb,0xac)   // highlighted
#define COLOR_MAIN_DISABLED     MARS_RGBCOLOR(0xBD,0xc1,0xC8)   // disabled

#define COLOR_MAIN_LINE         MARS_RGBCOLOR(0xf4,0xf4,0xf4)
#define COLOR_MAIN_BG           MARS_RGBCOLOR(0xff,0xff,0xff)
#define COLOR_MAIN_BG_HL        MARS_RGBCOLOR(0xf1,0xf2,0xf8)
#define COLOR_MAIN_TITLE        MARS_RGBCOLOR(0x3a,0x3a,0x3a)
#define COLOR_MAIN_SUBTITLE     MARS_RGBCOLOR(0xBD,0xC1,0xC8)
#define COLOR_MAIN_CONTENT      MARS_RGBCOLOR(0x9e,0xa0,0xae)

#define COLOR_LOCAL_RED         MARS_RGBCOLOR(0xee,0x4f,0x45)
#define COLOR_LOCAL_BLUE        MARS_RGBCOLOR(0x15,0x7E,0xFB)

#define kGZIMWatermarkFont          [UIFont systemFontOfSize:16]


#define NETCONTENTING @"连接中..."
#define NETCONTENTWORK @"在线客服"
